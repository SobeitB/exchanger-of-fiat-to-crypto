...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "...@mail.com", description: 'почта пользователя' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "qwerty123", description: 'пароль пользователя' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "Спамил порнуху", description: 'за что забанен пользователь' }),
